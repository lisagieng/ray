...
$(function() {
  $("#logo").click(function() {
    $("#div1").load("/ray/Subsections/home.html");
  ...
  $("#events").click(function() {
    $("#div1").load("/ray/Subsections/Locator/Events/Events.html");
      history.pushState('Events', 'Recycling & You', '/ray/Subsections/Events/Events.html');
  });
